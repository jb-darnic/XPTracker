...
maxtotlvl=2595;
maxqp=378;
taskmaster={"att":75,"str":76,"ran":64,"mag":83,"def":70,"hpx":35,"pra":95,"sum":95,"dun":95,"agi":90,"thi":91,"sla":93,"hun":59,"smi":95,"cra":98,"fle":85,"her":94,"run":91,"coo":95,"con":60,"fir":92,"woo":80,"far":91,"fis":96,"min":81,"div":86,"inv":0,"arc":0,"nec":0};

skillnames=["tot","att","str","ran","mag","def","hpx","pra","sum","dun","agi","thi","sla","hun","smi","cra","fle","her","run","coo","con","fir","woo","far","fis","min","div","inv","arc","nec"];
fullskillnames=["Total","Attack","Strength","Ranged","Magic","Defence","Constitution","Prayer","Summoning","Dungeoneering","Agility","Thieving","Slayer","Hunter","Smithing","Crafting","Fletching","Herblore","Runecrafting","Cooking","Construction","Firemaking","Woodcutting","Farming","Fishing","Mining","Divination","Invention","Archeology","Necromancy"];
...
function smartxptolvl(xp,skill,capped){
	...
	//apply cap
	if (capped) {
		if (skill == "inv" || skill == "dun" || skill == "sla" || skill == "her" || skill == "far" || skill == "arc" || skill == "nec") { lvl = Math.min(120, lvl); }
		else if (skill == "fir" || skill == "fle" || skill == "min" || skill == "smi" || skill == "woo" || skill == "run") { lvl = Math.min(110, lvl); }
