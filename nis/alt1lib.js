...
// USE NPM PACKAGE `@alt1/base` INSTEAD FOR ANY NEW PROJECTS
...
a1lib.hslitenames = ["totra", "totlv", "totxp", "attra", "-----", "attxp", "defra", "-----", "defxp", "strra", "-----", "strxp", "hpxra", "-----", "hpxxp", "ranra", "-----", "ranxp", "prara", "-----", "praxp", "magra", "-----", "magxp", "coora", "-----", "cooxp", "woora", "-----", "wooxp", "flera", "-----", "flexp", "fisra", "-----", "fisxp", "firra", "-----", "firxp", "crara", "-----", "craxp", "smira", "-----", "smixp", "minra", "-----", "minxp", "herra", "-----", "herxp", "agira", "-----", "agixp", "thira", "-----", "thixp", "slara", "-----", "slaxp", "farra", "-----", "farxp", "runra", "-----", "runxp", "hunra", "-----", "hunxp", "conra", "-----", "conxp", "sumra", "-----", "sumxp", "dunra", "-----", "dunxp", "divra", "-----", "divxp", "invra", "-----", "invxp", "arcra", "-----", "arcxp", "necra", "-----", "necxp", "-----", "-----", "-----", "-----", "domra", "domsc", "crura", "crusc", "casra", "cassc", "baara", "baasc", "badra", "badsc", "bacra", "bacsc", "bahra", "bahsc", "-----", "-----", "mobra", "mobsc", "cnqra", "cnqsc", "fogra", "fogsc", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----", "-----"];
...
a1lib.tablink = function (parent, id) {
	...
	fn = function (e) {
		...
		if (e.key == (me.parent ? "popup_callback_" : "popup_call_") + me.id) {
			...
			//TODO trace down if any code is still trying toc all this
